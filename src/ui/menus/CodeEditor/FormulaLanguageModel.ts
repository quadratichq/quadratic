...
export const FormulaCompletionProvider = {
  ...
  provideCompletionItems: (model, position, context, token) => {
    var suggestions = [
      ...
      suggestion('AND', '${1:arguments}', 'Returns TRUE if all arguments are truthy, or FALSE if any argument is falsey'),
      suggestion('OR', '${1:arguments}', 'Returns TRUE if any arguments is truthy, or FALSE if all arguments are falsey'),
      suggestion('XOR', '${1:arguments}', 'Returns TRUE if an odd number of arguments are truthy, or FALSE if an even number of arguments are truthy'),
      suggestion('IF', '${1:condition}, ${2:value_if_true}, ${3:value_if_false}', 'If the first argument is truthy, returns the second argument; otherwise returns the third argument'),
      // Statistics functions
