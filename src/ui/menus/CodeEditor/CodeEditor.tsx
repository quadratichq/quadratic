...
import useInspectPython from '../../../hooks/useInspectPython';
...
export const CodeEditor = (props: CodeEditorProps) => {
  ...
  const [pythonReturnType, setPythonReturnType] = useState<InspectPythonReturnType>();
  ...
  useInspectPython(editorContent, setPythonReturnType, editorRef, editorMode, selectedCell);
