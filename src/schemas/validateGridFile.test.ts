...
describe('validateFile()', () => {
  ...
  test('Upgrades a valid file from v1 to v1.3', () => {
    ...
    expect(result).toHaveProperty('sheets[0].borders[0].horizontal.type', 'line1');
    expect(result).toHaveProperty('sheets[0].borders[0].vertical.type', 'line1');
    expect(result).toHaveProperty('sheets[0].borders[1].horizontal.type', 'line2');
    expect(result).toHaveProperty('sheets[0].borders[2].horizontal.type', 'line3');
    expect(result).toHaveProperty('sheets[0].borders[3].horizontal.type', 'dotted');
    expect(result).toHaveProperty('sheets[0].borders[4].horizontal.type', 'dashed');
    expect(result).toHaveProperty('sheets[0].borders[5].horizontal.type', 'double');
    expect(result).toHaveProperty('sheets[0].borders[6].horizontal', {});
    expect(result).not.toHaveProperty('sheets[0].borders[7].horizontal');
  });

  test('Upgrades a valid file from v1.1 to v1.3', () => {
  ...
  test('Returns the file when it matches the most recent schema', () => {
    ...
    expect(v(v1_3File)).toStrictEqual(v1_3File);
  });
});
