...
export const useGridSettings = (): GridSettingsReturn => {
  ...
  const setShowGridAxes = useCallback((value: boolean) => {
  ...
  const setShowHeadings = useCallback((value: boolean) => {
  ...
  const setShowGridLines = useCallback((value: boolean) => {
  ...
  const setShowCellTypeOutlines = useCallback((value: boolean) => {
