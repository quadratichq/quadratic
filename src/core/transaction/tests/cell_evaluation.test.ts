...
test('SheetController - code run correctly', async () => {
  ...
  await updateCellAndDCells({ starting_cell: cell, sheetController: sc, pyodide });
...
test('SheetController - array output length change', async () => {
  ...
  await updateCellAndDCells({ starting_cell: cell_update_1, sheetController: sc, pyodide });
