...
ENV VITE_DEBUG=0
ENV VITE_QUADRATIC_API_URL=http://localhost:8000
ENV VITE_QUADRATIC_MULTIPLAYER_URL=ws://localhost:3001/ws
ENV VITE_QUADRATIC_CONNECTION_URL=http://localhost:3003
ENV VITE_AUTH_TYPE=ory
ENV VITE_ORY_HOST=http://localhost:4433
