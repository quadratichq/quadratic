...
mod tests {
    ...
    fn test_column_name_valid_names_unchanged() {
        ...
        assert_eq!(fix_column_name("valid_name".to_string()), "valid_name");
        assert_eq!(fix_column_name("a".to_string()), "a");
        assert_eq!(fix_column_name("A".to_string()), "A");
        assert_eq!(fix_column_name("1".to_string()), "1");
        assert_eq!(fix_column_name("column_1".to_string()), "column_1");
        assert_eq!(
            fix_column_name("Column-Name-123".to_string()),
            "Column-Name-123"
        );
        assert_eq!(fix_column_name("_private".to_string()), "_private");
        assert_eq!(fix_column_name("camelCase".to_string()), "camelCase");
        assert_eq!(fix_column_name("UPPER_CASE".to_string()), "UPPER_CASE");
        assert_eq!(fix_column_name("test-name".to_string()), "test-name");
        assert_eq!(
            fix_column_name("name_with_123".to_string()),
            "name_with_123"
        );
    }
    ...
    fn test_column_name_valid_first_characters() {
        ...
        assert_eq!(fix_column_name("a".to_string()), "a");
        assert_eq!(fix_column_name("Z".to_string()), "Z");
        assert_eq!(fix_column_name("0".to_string()), "0");
        assert_eq!(fix_column_name("9".to_string()), "9");
        assert_eq!(fix_column_name("_".to_string()), "_");
    ...
    fn test_column_name_valid_middle_characters() {
        ...
        assert_eq!(
            fix_column_name("a_b-c d.e(f)g".to_string()),
            "a_b-c d.e(f)g"
        );
        assert_eq!(fix_column_name("test 123".to_string()), "test 123");
        assert_eq!(
            fix_column_name("name.with.dots".to_string()),
            "name.with.dots"
        );
        assert_eq!(
            fix_column_name("parentheses(test)".to_string()),
            "parentheses(test)"
        );
        assert_eq!(fix_column_name("with-dashes".to_string()), "with-dashes");
        assert_eq!(fix_column_name("under_scores".to_string()), "under_scores");
    }
    ...
    fn test_column_name_valid_final_characters() {
        ...
        assert_eq!(fix_column_name("end_with_a".to_string()), "end_with_a");
        assert_eq!(fix_column_name("end_with_Z".to_string()), "end_with_Z");
        assert_eq!(fix_column_name("end_with_1".to_string()), "end_with_1");
        assert_eq!(fix_column_name("end_with_9".to_string()), "end_with_9");
        assert_eq!(fix_column_name("end_with_".to_string()), "end_with_");
        assert_eq!(fix_column_name("end_with-".to_string()), "end_with-");
    }
    ...
    fn test_column_name_long_names() {
        ...
        assert_eq!(
            fix_column_name("this_is_a_very_long_valid_column_name_123".to_string()),
