...
pub use borders::{
    ...
    set_rects_borders, BorderSelection, BorderStyle, CellBorderLine, CellBorders, CellSide,
...
impl Grid {
    ...
    /// autogenerated name.
    ///
    /// Errors if the sheet name is already in use.
    pub fn add_sheet(&mut self, sheet: Option<Sheet>) -> Result<SheetId> {
        ...
        // TODO: handle duplicate ID (probably error)
