...
// `block.rs` in the `contiguous` module. Only the parts necessary for
// `SheetFormatting` upgrade are included.
...
use crate::grid::file::v1_7_1::{
    BlockSchema, CellAlignSchema, CellVerticalAlignSchema, CellWrapSchema, NumericFormatSchema,
    RenderSizeSchema,
};

use super::schema::FormatSchema;
