    ...
    pub fn into_latest(self) -> Result<Sheet> {
        match self {
            ...
            SheetSchema::V1_11(sheet) => {
                SheetSchema::V1_12(v1_11::upgrade_sheet(sheet)).into_latest()
            }
            SheetSchema::V1_10(sheet) => {
                SheetSchema::V1_11(v1_10::upgrade_sheet(sheet)).into_latest()
            }
            SheetSchema::V1_9(sheet) => {
                SheetSchema::V1_10(v1_9::upgrade_sheet(sheet)).into_latest()
            }
            SheetSchema::V1_8(sheet) => SheetSchema::V1_9(v1_8::upgrade_sheet(sheet)).into_latest(),
            SheetSchema::V1_7_1(sheet) => {
                SheetSchema::V1_8(v1_7_1::upgrade_sheet(sheet)).into_latest()
            }
            SheetSchema::V1_7(sheet) => {
                SheetSchema::V1_7_1(v1_7::upgrade_sheet(sheet)).into_latest()
            }
            SheetSchema::V1_6(sheet) => {
                SheetSchema::V1_7(v1_6::file::upgrade_sheet(sheet)?).into_latest()
            }
        }
    }
}
