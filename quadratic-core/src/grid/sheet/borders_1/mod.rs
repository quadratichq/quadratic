...
use crate::grid::{block::Block, ColumnData};
...
pub struct Borders {
    ...
    pub(crate) top: HashMap<i64, ColumnData<Block<BorderStyle>>>,
    pub(crate) bottom: HashMap<i64, ColumnData<Block<BorderStyle>>>,

    // note, this ColumnData is actually horizontal
    pub(crate) left: HashMap<i64, ColumnData<Block<BorderStyle>>>,
    pub(crate) right: HashMap<i64, ColumnData<Block<BorderStyle>>>,
}
