...
impl Grid {
    ...
    pub(crate) fn first_sheet_id(&self) -> SheetId {
    ...
    /// This method panics if the grid contains no sheets.
    #[cfg(test)]
    pub(crate) fn first_sheet(&self) -> &Sheet {
    ...
    pub(crate) fn sheet_ids(&self) -> Vec<SheetId> {
    ...
    pub(crate) fn try_sheet_from_name(&self, name: &str) -> Option<&Sheet> {
    ...
    pub(crate) fn sort_sheets(&mut self) {
        self.sheets
    ...
    pub(crate) fn end_order(&self) -> String {
    ...
    pub(crate) fn previous_sheet_order(&self, sheet_id: SheetId) -> Option<&str> {
    ...
    pub(crate) fn next_sheet(&self, sheet_id: SheetId) -> Option<&Sheet> {
        let i = self.sheets.get_index_of(&sheet_id)?;
    ...
    pub(crate) fn unique_sheet_name(&self, name: &str) -> String {
    ...
    pub(crate) fn add_sheet(&mut self, sheet: Option<Sheet>) -> SheetId {
    ...
    pub(crate) fn remove_sheet(&mut self, sheet_id: SheetId) -> Option<Sheet> {
        let i = self.sheets.get_index_of(&sheet_id);
        match i {
    ...
    /// appropriately.
    pub(crate) fn move_sheet(&mut self, target: SheetId, order: String) {
    ...
    pub(crate) fn sheet_id_to_index(&self, id: SheetId) -> Option<usize> {
    ...
    pub(crate) fn update_sheet_name(
        &mut self,
        sheet_id: SheetId,
        new_name: &str,
    ) -> Result<String> {
