...
impl GridController {
    pub fn set_sheet_name(&mut self, sheet_id: SheetId, name: String, cursor: Option<String>) {
        ...
        self.start_user_transaction(ops, cursor, TransactionName::SetSheetMetadata, None);
    }
    ...
    pub fn add_sheet(&mut self, cursor: Option<String>) {
        ...
        self.start_user_transaction(ops, cursor, TransactionName::SheetAdd, None);
    }
    ...
    pub fn delete_sheet(&mut self, sheet_id: SheetId, cursor: Option<String>) {
        ...
        self.start_user_transaction(ops, cursor, TransactionName::SheetDelete, None);
    }
    pub fn move_sheet(
        &mut self,
        sheet_id: SheetId,
    ...
    pub fn duplicate_sheet(&mut self, sheet_id: SheetId, cursor: Option<String>) {
        ...
        self.start_user_transaction(ops, cursor, TransactionName::DuplicateSheet, None);
    }
}
