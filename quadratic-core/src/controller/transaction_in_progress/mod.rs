...
use crate::controller::{
    operation::Operation, transaction_summary::TransactionSummary, transaction_types::JsCodeResult,
    GridController,
};
...
mod test {
    ...
    fn test_js_code_result_to_code_cell_value_array() {
        ...
        assert_eq!(gc.forward_operations.len(), 5);
    }
}
