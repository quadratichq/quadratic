...
impl GridController {
    ...
    //     sheet.offsets.cell_offsets(column as i64, row as i64)
    // }
    ...
    //     let sheet = self.grid().sheet_from_string(sheet_id);
    //     sheet.offsets.column_width(x as i64) as f32
    // }
    ...
    //     let sheet = self.grid().sheet_from_string(sheet_id);
    //     sheet.offsets.row_height(y as i64) as f32
    // }
    ...
    //     let sheet = self.grid().sheet_from_string(sheet_id);
    //     let (position, size) = sheet.offsets.column_position_size(column as i64);
    //     Placement {
    //         index: column,
    //         position,
    //         size: size as i32,
    ...
    //     let sheet = self.grid().sheet_from_string(sheet_id);
    //     let (position, size) = sheet.offsets.row_position_size(row as i64);
    //     Placement {
    //         index: row,
    //         position,
    //         size: size as i32,
    ...
    //     let sheet = self.grid().sheet_from_string(sheet_id);
    //     let index = sheet.offsets.column_from_x(x);
    //     Placement {
    //         index: index.0 as i32,
    //         position: index.1,
    //         size: sheet.offsets.column_width(index.0) as i32,
    //     }
    // }
    // /// gets the screen coordinate and size for a pixel y-coordinate. Returns a [`Placement`]
    ...
    //     let sheet = self.grid().sheet_from_string(sheet_id);
    //     let index = sheet.offsets.row_from_y(y);
    //     Placement {
    //         index: index.0 as i32,
    //         position: index.1,
    //         size: sheet.offsets.row_height(index.0) as i32,
    //     }
    // }
}
