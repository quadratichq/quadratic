...
impl Grid {
    ...
    pub fn js_sheet_id_to_index(&self, sheet_id: String) -> Option<usize> {
    ...
    pub fn js_sheet_index_to_id(&self, index: usize) -> Result<JsValue, JsValue> {
        match self.sheet_index_to_id(index) {
            Some(sheet_id) => Ok(serde_wasm_bindgen::to_value(&sheet_id.id_to_string())?),
    ...
    pub fn populate_with_random_floats(&mut self, sheet_id: String, region: &Rect) {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn recalculate_bounds(&mut self, sheet_id: String) {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn get_render_code_cells(&self, sheet_id: String) -> Result<String, JsValue> {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn get_render_horizontal_borders(&self, sheet_id: String) -> Result<String, JsValue> {
        let sheet_id = SheetId::from_string(&sheet_id);
        let output = self.sheet_from_id(sheet_id).get_render_horizontal_borders();
    ...
    pub fn delete_cell_values(&mut self, sheet_id: String, region: &Rect) -> Result<(), JsValue> {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn get_formatting_summary(
        ...
        let sheet_id = SheetId::from_string(&sheet_id);
        let output: FormattingSummary =
            self.sheet_from_id(sheet_id).get_formatting_summary(*region);
    ...
    pub fn set_cell_bold(&mut self, sheet_id: String, region: &Rect, value: bool) {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn set_cell_italic(&mut self, sheet_id: String, region: &Rect, value: bool) {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn set_cell_text_color(&mut self, sheet_id: String, region: &Rect, value: String) {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn set_cell_fill_color(&mut self, sheet_id: String, region: &Rect, value: String) {
        let sheet_id = SheetId::from_string(&sheet_id);
    ...
    pub fn clear_formatting(&mut self, sheet_id: String, region: &Rect) {
        let sheet_id = SheetId::from_string(&sheet_id);
