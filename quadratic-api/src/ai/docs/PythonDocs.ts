...
NOTE THAT IN THE ABOVE EXAMPLE, ONLY THE CORRELATION MATRIX IS RETURNED TO THE SHEET. THE CHART DOES NOT GET SHOWN SINCE IT IS NOT THE LAST LINE OF CODE. IF YOU WANT THE CHART AS WELL, CREATE A SEPERATE CODE CELL. ONLY ONE ITEM CAN BE RETURNED TO THE SHEETPER CODE CELL.
