...
export const getTeamAccess = (role: any /*UserRoleTeam*/) => {
...
export const firstRoleIsHigherThanSecond = (
  firstRole: any, // UserRoleTeam | UserRoleFile,
  secondRole: any // UserRoleTeam | UserRoleFile
) => {
  return true;
