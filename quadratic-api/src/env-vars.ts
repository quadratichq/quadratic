...
export const PROMPTLAYER_API_KEY = process.env.PROMPTLAYER_API_KEY || '';
export const PROMPTLAYER_WORKSPACE_ID = parseInt(process.env.PROMPTLAYER_WORKSPACE_ID || '19736', 10);
