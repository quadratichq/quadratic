...
describe('READ - GET /v0/files/:uuid/sharing - without auth', () => {
  it('responds with a 4xx error', async () => {
    await request(app)
...
describe('READ - GET /v0/files/:uuid/sharing - for a file you own', () => {
...
describe('READ - GET /v0/files/:uuid/sharing - for a file you have access to via a team', () => {
