...
-- CreateIndex
CREATE INDEX "ScheduledTaskLog_run_id_created_date_idx" ON "ScheduledTaskLog"("run_id", "created_date" DESC);

-- CreateIndex
CREATE INDEX "ScheduledTaskLog_created_date_idx" ON "ScheduledTaskLog"("created_date" DESC);
