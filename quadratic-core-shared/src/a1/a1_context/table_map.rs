...
use crate::{CodeCellLanguage, Pos, SheetId, SheetPos, TableInfo, util::case_fold_ascii};
...
impl TableMap {
    ...
    pub fn insert_table(&mut self, sheet_id: SheetId, table_info: TableInfo) {
        let table_map_entry = TableMapEntry::from_table(sheet_id, table_info);
    ...
    pub fn test_insert(
        ...
        bounds: crate::Rect,
        language: crate::CodeCellLanguage,
    ) {
...
mod tests {
    ...
    use crate::{CodeCellLanguage, Rect};
