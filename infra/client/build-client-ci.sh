...
if [ "$VERCEL_ENV" == "preview" ]; then
  ...
  export VITE_QUADRATIC_CONNECTOR_URL="https://connector-pr-$VERCEL_GIT_PULL_REQUEST_ID.quadratic-preview.com"
  echo "On preview branch. Setting VITE_QUADRATIC_CONNECTOR_URL to https://connector-pr-$VERCEL_GIT_PULL_REQUEST_ID.quadratic-preview.com"
fi
