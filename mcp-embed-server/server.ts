...
export function createServer(): McpServer {
  ...
  appTool(
      ...
      '(text, number, or formula prefixed with "=").',
    {
      ...
      top_left_position: STR.describe(
        'Top-left cell in A1 notation, e.g. "A1"'
      ),
      cell_values: z
        .array(z.array(STR))
  ...
  appTool(
    "has_cell_data",
    "Check if any cells in the chosen selection have data.",
    {
      sheet_name: STR_OPT.describe("Sheet name"),
  ...
  appTool(
      ...
      "Supported languages: Python, Javascript.",
    {
      ...
      code_cell_position: STR.describe(
        'Cell position in A1 notation, e.g. "A1"'
      ),
  ...
  appTool(
    ...
    "Set one or more formula cells. Do NOT prefix formulas with =.",
    {
      formulas: z
        .array(
          z.object({
            sheet_name: STR_OPT.describe("Sheet name"),
            code_cell_position: STR.describe(
              'Cell position or range in A1 notation'
            ),
