...
export const MODELS_CONFIGURATION: {
  ...
  'openai:ft:gpt-4.1-mini-2025-04-14:quadratic::BXe8iYRT': {
    model: 'ft:gpt-4.1-mini-2025-04-14:quadratic::BXe8iYRT',
    ...
    model: 'ft:gpt-4.1-mini-2025-04-14:quadratic::BYv7cTdE',
    displayName: 'gpt 4.1 mini fine-tuned (unstable)',
    temperature: 0,
    max_tokens: 16384,
    canStream: true,
    canStreamWithToolCalls: true,
    ...
    displayName: 'gpt 4.1 mini fine-tuned (experimental)',
    temperature: 0,
    max_tokens: 16384,
    canStream: true,
    canStreamWithToolCalls: true,
