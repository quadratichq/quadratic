...
export const MODELS_CONFIGURATION: {
  ...
  'fireworks:accounts/fireworks/models/kimi-k2p5': {
    ...
    promptCaching: true,
    strictParams: false, // Fireworks doesn't support strict parameter
    imageSupport: true, // K2.5 supports vision
    rate_per_million_input_tokens: 0.6,
    rate_per_million_output_tokens: 2.5,
  ...
  'fireworks:accounts/fireworks/models/kimi-k2p5:thinking-toggle-on': {
    ...
    displayName: 'Kimi K2.5',
    displayProvider: 'Moonshot AI',
    temperature: 1.0, // Fireworks recommends 1.0 for reasoning models
    max_tokens: 0, // use api default
    canStream: true,
    canStreamWithToolCalls: true,
    mode: 'disabled',
    ...
    thinking: true,
    thinkingToggle: true,
    reasoningEffort: 'high', // Fireworks reasoning effort level (max)
    imageSupport: true,
    rate_per_million_input_tokens: 0.6,
    rate_per_million_output_tokens: 2.5,
    rate_per_million_cache_read_tokens: 0.3,
