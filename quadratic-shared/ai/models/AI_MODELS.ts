...
export const MODELS_CONFIGURATION: {
  ...
  'vertexai-anthropic:claude-opus-4-5@20251101:thinking-toggle-on': {
    ...
    displayName: 'Opus 4.5',
    displayProvider: 'Claude',
    displayDescription: 'The most powerful model in Quadratic. Best for complex analysis and reasoning tasks.',
    temperature: 1,
    max_tokens: 64000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'vertexai-anthropic:claude-haiku-4-5@20251001': {
    ...
    displayName: 'Haiku 4.5',
    displayProvider: 'Claude',
    displayDescription: 'Fast and cost-effective. Ideal for quick queries and simple tasks.',
    temperature: 1,
    max_tokens: 64000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'azure-openai:gpt-5-codex': {
    ...
    displayName: 'GPT-5-Codex',
    displayProvider: 'OpenAI',
    displayDescription: 'Optimized for code generation and technical tasks.',
    temperature: 1,
    max_tokens: 128000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'azure-openai:gpt-5.2': {
    ...
    displayName: 'GPT-5.2',
    displayProvider: 'OpenAI',
    displayDescription: "OpenAI's most capable model with advanced reasoning.",
    temperature: 1,
    max_tokens: 128000,
    canStream: true,
    canStreamWithToolCalls: true,
