...
export const MODELS_CONFIGURATION: {
  ...
  'vertexai-anthropic:claude-sonnet-4-5@20250929:thinking-toggle-on': {
    ...
    displayName: 'Sonnet 4.5',
    displayProvider: 'Claude',
    displayDescription: 'Excellent balance of speed and intelligence. Great for most tasks.',
    temperature: 1,
    max_tokens: 64000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'vertexai-anthropic:claude-opus-4-5@20251101:thinking-toggle-on': {
    ...
    displayName: 'Opus 4.5',
    displayProvider: 'Claude',
    displayDescription: 'Advanced reasoning with strong analytical capabilities.',
    temperature: 1,
    max_tokens: 64000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'vertexai-anthropic:claude-opus-4-6@20260205:thinking-toggle-on': {
    ...
    displayName: 'Opus 4.6',
    displayProvider: 'Claude',
    displayDescription: 'Most capable model. Best for complex reasoning and analysis.',
    temperature: 1,
    max_tokens: 128000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'vertexai-anthropic:claude-opus-4-6@20260205': {
    ...
    displayName: 'Opus 4.6',
    displayProvider: 'Claude',
    displayDescription: 'Most capable model without extended thinking.',
    temperature: 1,
    max_tokens: 128000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'vertexai-anthropic:claude-haiku-4-5@20251001': {
    ...
    displayName: 'Haiku 4.5',
    displayProvider: 'Claude',
    displayDescription: 'Fast and efficient. Great for simple tasks.',
    temperature: 1,
    max_tokens: 64000,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'vertexai:gemini-3-pro-preview': {
    ...
    displayName: '3 Pro',
    displayProvider: 'Gemini',
    displayDescription: 'Google\u2019s latest pro model with strong reasoning.',
    temperature: 0.1,
    max_tokens: 65535,
    canStream: true,
    canStreamWithToolCalls: true,
  ...
  'openai:gpt-5-codex': {
    model: 'gpt-5-codex',
    backupModelKey: 'vertexai:gemini-3-pro-preview',
  ...
  'azure-openai:gpt-5.2': {
    ...
    displayName: 'GPT-5.2',
    displayProvider: 'OpenAI',
    displayDescription: 'OpenAI\u2019s latest flagship reasoning model.',
    temperature: 1,
    max_tokens: 128000,
    canStream: true,
    canStreamWithToolCalls: true,
