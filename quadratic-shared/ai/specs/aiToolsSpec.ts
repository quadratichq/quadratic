...
- If the referenced data is portrait in a table format (more vertical than horizontal), the code cell should be next to the top right corner of the table.\n
- If the referenced data is landscape in a table format (more horizontal than vertical), the code cell should be below the bottom left corner of the table.\n
- If unsure, default to placing the code cell to the right of the referenced data, not underneath.\n
