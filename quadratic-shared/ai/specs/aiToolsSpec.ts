...
- In situations where you're adding code that references data or adds additional code next to existing code on the sheet, leave a blank row / column between the code cell and the data it references. Example if placing to the right: if nearest content is in D1 and you're inserting to the right, you would use F1; example placement underneath: if nearest content is in C17 and you're inserting below, you would use C19. In the case of inserting code next to a text label, it is okay to place the code in the cell next to the label.\n
