...
The label is a descriptive label for the prompt suggestion with maximum 6 words, this will be displayed to the user in the UI.\n
        ...
        prompt_suggestions: {
          ...
          items: {
            ...
            properties: {
              label: {
                type: 'string',
                description: 'The label of the follow up prompt, maximum 6 words',
              },
              prompt: {
                type: 'string',
                description:
