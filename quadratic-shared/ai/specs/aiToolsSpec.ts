...
- If inserting the code cell as a calculation cell that has an adjacent label, as in a calculator or other situation where the code should not use a gap, do not leave a gap to the nearest content.\n
