    ...
    parameters: {
      ...
      properties: {
        ai_model: {
          type: 'string',
          description:
            'Value can be only one of the following: "claude" or "4.1" models exactly, this is the model best suited for the user prompt based based on examples and model capabilities.\n',
        },
      },
      required: ['ai_model'],
