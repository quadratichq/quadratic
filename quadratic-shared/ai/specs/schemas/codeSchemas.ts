...
Always refer to the data from cell by its position in a1 notation from respective sheet, using q.cells function. Don't add values manually in code cells.\n
