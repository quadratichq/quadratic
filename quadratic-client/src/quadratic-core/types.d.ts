...
export interface TransactionSummary { fill_sheets_modified: Array<SheetId>, border_sheets_modified: Array<SheetId>, code_cells_modified: Array<SheetId>, sheet_list_modified: boolean, cell_sheets_modified: Array<CellSheetsModified>, offsets_modified: Array<SheetId>, cursor: string | null, save: boolean, generate_thumbnail: boolean, transaction_id: string | null, operations: string | null, html: Array<SheetId>, request_transactions: bigint | null, error: CoreError | null, }
export interface CellSheetsModified { sheet_id: string, x: number, y: number, }
...
export type JsRenderCellSpecial = "Chart" | "SpillError" | "RunError";
...
export interface JsClipboard { summary: TransactionSummary | null, plainText: string, html: string, }
