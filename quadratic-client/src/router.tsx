  ...
  createRoutesFromElements(
    <>
      ...
      <Route id={ROUTE_LOADER_IDS.ROOT} lazy={() => import('./routes/_root')} HydrateFallback={EmptyComponent}>
        ...
        <Route path={ROUTES.FILES_CREATE_AI_PROMPT} lazy={() => import('./routes/files.create.ai')} />
        <Route path={ROUTES.FILES_CREATE_AI_FILE} lazy={() => import('./routes/files.create.ai')} />
        <Route path={ROUTES.FILES_CREATE_AI_PDF} lazy={() => import('./routes/files.create.ai')} />
        <Route path={ROUTES.FILES_CREATE_AI_CONNECTION} lazy={() => import('./routes/files.create.ai')} />
        <Route path={ROUTES.FILES_CREATE_AI_WEB} lazy={() => import('./routes/files.create.ai')} />
