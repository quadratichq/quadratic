...
export interface JsCodeResult { transaction_id: string, success: boolean, error_msg: string | null, input_python_std_out: string | null, output_value: Array<string> | null, array_output: Array<Array<Array<string>>> | null, line_number: number | null, output_type: string | null, cancel_compute: boolean | null, output_bytes: Array<number> | null, }
