...
export const DOCUMENTATION_SCHEDULED_TASKS_URL = `${DOCUMENTATION_URL}/scheduled-tasks`;
export const DOCUMENTATION_CRON = `${DOCUMENTATION_URL}/scheduled-tasks/cron-expressions`;
