...
export const DOCUMENTATION_JAVASCRIPT_URL = `${DOCUMENTATION_URL}/javascript-experimental/getting-started`;
export const DOCUMENTATION_JAVASCRIPT_RETURN_DATA = `${DOCUMENTATION_URL}/javascript-experimental/return-data-to-the-sheet`;
