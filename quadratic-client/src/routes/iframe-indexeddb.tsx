...
// On submitting the prompt, the user is redirected to app with the chatid as a query param where this iframe is loaded again,
// files are loaded from the indexeddb and imported into the grid / ai analyst based on file type
