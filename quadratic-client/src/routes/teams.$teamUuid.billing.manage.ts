...
/**
 * This route is used to redirect users directly to Stripe's billing portal
...
export const loader = async ({ request, params }: LoaderFunctionArgs) => {
  ...
  try {
    ...
    const url = await apiClient.teams.billing.getPortalSessionUrl(teamUuid).then((data) => data.url);
