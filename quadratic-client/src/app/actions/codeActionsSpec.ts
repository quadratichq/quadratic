...
export const executeCode = () => {
  ...
  quadraticCore.rerunCodeCells(sheets.current, selection, false);
};

export const rerunSheetCode = () => {
  quadraticCore.rerunCodeCells(sheets.current, undefined, false);
};

export const rerunAllCode = () => {
  quadraticCore.rerunCodeCells(undefined, undefined, false);
};
