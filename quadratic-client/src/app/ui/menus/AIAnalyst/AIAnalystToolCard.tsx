...
import { SetAIResearcherValue } from '@/app/ui/menus/AIAnalyst/toolCards/SetAIResearcherValue';
...
export const AIAnalystToolCard = ({ name, args, loading }: AIAnalystToolCardProps) => {
  ...
  switch (name) {
    ...
    case AITool.SetAIResearcherValue:
      return <SetAIResearcherValue args={args} loading={loading} />;
