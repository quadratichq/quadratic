...
const getConditionalFormatsToolCall = (sheetName: string): string => {
...
const updateConditionalFormatsToolCall = async (
...
export const conditionalFormatToolsActions: ConditionalFormatToolActions = {
