...
type AddNumberValidationResponse = z.infer<(typeof AIToolsArgsSchema)[AITool.AddNumberValidation]>;

export const AddNumberValidation = memo(
  ({ toolCall: { arguments: args, loading }, className }: { toolCall: AIToolCall; className: string }) => {
    const [toolArgs, setToolArgs] =
      useState<z.SafeParseReturnType<AddNumberValidationResponse, AddNumberValidationResponse>>();
