...
type SetDefaultRowHeightResponse = z.infer<(typeof aiToolsSpec)[AITool.SetDefaultRowHeight]['responseSchema']>;
  ...
  ({ toolCall: { arguments: args, loading }, className }: { toolCall: AIToolCall; className: string }) => {
    ...
    useEffect(() => {
      ...
      try {
        ...
        setToolArgs(aiToolsSpec[AITool.SetDefaultRowHeight].responseSchema.safeParse(json));
      } catch (error) {
        setToolArgs(undefined);
