...
- Sheet name is case insensitive, and should be enclosed in single quotes when there are spaces or special characters in the name.
- To reference data from different tabular data rectangles, use multiple \`q.cells\` functions.

## User's selection
The user is in sheet "${sheetName}" and can see cells in ${visibleA1String}. The user's cursor is located at ${sheets.sheet.cursor.a1String()} and their selection is ${sheets.getA1String(sheets.current)}.`;
