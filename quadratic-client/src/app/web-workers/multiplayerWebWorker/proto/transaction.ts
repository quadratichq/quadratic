...
class SendGetTransactions$Type extends MessageType<SendGetTransactions> {
    constructor() {
        super("multiplayer.SendGetTransactions", [
            ...
            { no: 4, name: "min_sequence_num", kind: "scalar", localName: "min_sequence_num", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: SendGetTransactions, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string session_id = 2; */
        if (message.session_id !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.session_id);
        /* string file_id = 3; */
        if (message.file_id !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.file_id);
        /* uint64 min_sequence_num = 4; */
        if (message.min_sequence_num !== 0n)
            writer.tag(4, WireType.Varint).uint64(message.min_sequence_num);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class ReceiveTransaction$Type extends MessageType<ReceiveTransaction> {
    constructor() {
        super("multiplayer.ReceiveTransaction", [
            ...
            { no: 2, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "file_id", kind: "scalar", localName: "file_id", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "sequence_num", kind: "scalar", localName: "sequence_num", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 5, name: "operations", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    ...
    internalBinaryWrite(message: ReceiveTransaction, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.sequence_num !== 0n)
            writer.tag(4, WireType.Varint).uint64(message.sequence_num);
        /* bytes operations = 5; */
        if (message.operations.length)
            writer.tag(5, WireType.LengthDelimited).bytes(message.operations);
        let u = options.writeUnknownFields;
