...
export type JsCellValueDescription = { total_range: string, range: string, values: Array<Array<JsCellValueCode>>, };
...
export type JsChartSummaryContext = { sheet_name: string, chart_name: string, bounds: string, };
export type JsDataTableColumnHeader = { name: string, display: boolean, valueIndex: number, };
export type JsDataTableContext = { sheet_name: string, data_table_name: string, all_columns: Array<string>, visible_columns: Array<string>, first_rows_visible_values: JsCellValueDescription, last_rows_visible_values: JsCellValueDescription | null, bounds: string, intended_bounds: string, show_name: boolean, show_columns: boolean, spill: boolean, };
...
export type JsSelectionContext = { sheet_name: string, data_rects: Array<JsCellValueDescription>, errored_code_cells: Array<JsCodeCell> | null, tables_summary: Array<JsTableSummaryContext> | null, charts_summary: Array<JsChartSummaryContext> | null, };
...
export type JsTableSummaryContext = { sheet_name: string, table_name: string, table_type: JsTableType, bounds: string, connection_name: string | null, connection_id: string | null, };
export type JsTableType = "dataTable" | "formula" | "python" | "javascript" | "connection";
