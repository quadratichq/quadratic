...
=======
export interface JsCodeResult { transaction_id: string, success: boolean, std_out: string | null, std_err: string | null, line_number: number | null, output_value: Array<string> | null, output_array: Array<Array<Array<string>>> | null, output_display_type: string | null, cancel_compute: boolean | null, chart_output: [number, number] | null, }
>>>>>>> 5004a80fd2f0dc59f508ef3c19efd1772472f42f
...
export interface JsRenderCodeCell { x: number, y: number, w: number, h: number, language: CodeCellLanguage, state: JsRenderCodeCellState, spill_error: Array<Pos> | null, name: string, columns: Array<JsDataTableColumn>, first_row_header: boolean, show_header: boolean, sort: Array<DataTableSort> | null, display_buffer: Array<bigint> | null, alternating_colors: boolean, }
