...
export interface DataTableColumn { name: string, display: boolean, value_index: number, }
...
export type JsRenderCellSpecial = "Chart" | "SpillError" | "RunError" | "Logical" | "Checkbox" | "List" | "TableHeading";
export interface JsRenderCodeCell { x: number, y: number, w: number, h: number, language: CodeCellLanguage, state: JsRenderCodeCellState, spill_error: Array<Pos> | null, name: string, column_names: Array<DataTableColumn>, first_row_header: boolean, show_header: boolean, }
