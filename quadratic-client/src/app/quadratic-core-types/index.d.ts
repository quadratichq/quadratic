...
export type JsCellValuePosContext = { sheet_name: string, rect_origin: string, rect_width: number, rect_height: number, starting_rect_values: Array<string> | null, };
...
export type JsCodeTableContext = { sheet_name: string, code_table_name: string, all_columns: Array<string>, visible_columns: Array<string>, first_row_visible_values: Array<string> | null, last_row_visible_values: Array<string> | null, bounds: string, intended_bounds: string, show_name: boolean, show_columns: boolean, language: CodeCellLanguage, code_string: string, std_err: string | null, error: boolean, spill: boolean, };
...
export type JsDataTableContext = { sheet_name: string, data_table_name: string, all_columns: Array<string>, visible_columns: Array<string>, first_row_visible_values: Array<string> | null, last_row_visible_values: Array<string> | null, bounds: string, intended_bounds: string, show_name: boolean, show_columns: boolean, spill: boolean, };
