...
export type FormatUpdate = { align: string | null | null, vertical_align: string | null | null, wrap: string | null | null, numeric_format: NumericFormat | null | null, numeric_decimals: NumericFormat | null | null, numeric_commas: number | null | null, bold: boolean | null | null, italic: boolean | null | null, text_color: string | null | null, fill_color: string | null | null, render_size: RenderSize | null | null, date_time: string | null | null, underline: boolean | null | null, strike_through: boolean | null | null, };
...
export type JsCodeCell = { x: bigint, y: bigint, code_string: string, language: CodeCellLanguage, std_out: string | null, std_err: string | null, evaluation_result: string | null, spill_error: Array<Pos> | null, return_info: JsReturnInfo | null, cells_accessed: Array<JsCellsAccessed> | null, };
...
export type JsValidationWarning = { x: bigint, y: bigint, validation: string | null, style: ValidationStyle | null, };
...
export type SheetBounds = { sheet_id: string, bounds: GridBounds, bounds_without_formatting: GridBounds, };
export type SheetId = { id: string, };
export type SheetInfo = { sheet_id: string, name: string, order: string, color: string | null, offsets: string, bounds: GridBounds, bounds_without_formatting: GridBounds, };
