...
export type A1Error = { "InvalidSheetId": string } | { "InvalidSheetMap": string } | { "InvalidColumn": string } | { "InvalidSheetName": string } | { "InvalidSheetNameMissingQuotes": string } | { "InvalidRange": string } | { "InvalidRow": string } | { "TooManySheets": string } | { "WrongCellCount": string } | { "InvalidExclusion": string } | { "TranslateInvalid": string };
