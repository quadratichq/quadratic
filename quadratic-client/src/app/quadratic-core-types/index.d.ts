...
export type JsCellValueDescription = { total_range: string, range: string, values: Array<Array<JsCellValueCode>> | null, };
...
export type JsCodeTableContext = { sheet_name: string, code_table_name: string, all_columns: Array<string>, visible_columns: Array<string>, first_rows_visible_values: JsCellValueDescription | null, last_rows_visible_values: JsCellValueDescription | null, bounds: string, intended_bounds: string, show_name: boolean, show_columns: boolean, language: CodeCellLanguage, code_string: string, std_err: string | null, error: boolean, spill: boolean, };
...
export type JsDataTableContext = { sheet_name: string, data_table_name: string, all_columns: Array<string>, visible_columns: Array<string>, first_rows_visible_values: JsCellValueDescription | null, last_rows_visible_values: JsCellValueDescription | null, bounds: string, intended_bounds: string, show_name: boolean, show_columns: boolean, spill: boolean, };
...
export type JsGetAICellResult = { selection: string, page: number, total_pages: number, values: Array<JsCellValueDescription>, };
...
export type JsSummaryContext = { sheet_name: string, data_rects: Array<JsCellValueDescription>, errored_code_cells: Array<JsCodeCell> | null, data_tables: Array<JsDataTableContext> | null, code_tables: Array<JsCodeTableContext> | null, connections: Array<JsCodeTableContext> | null, charts: Array<JsChartContext> | null, };
