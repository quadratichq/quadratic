...
export type A1Error =
  | { type: 'InvalidCellReference'; error: string }
  | { type: 'InvalidSheetId'; error: string }
  | { type: 'InvalidSheetMap'; error: string }
  | { type: 'InvalidColumn'; error: string }
  | { type: 'InvalidSheetName'; error: string }
  | { type: 'InvalidSheetNameMissingQuotes'; error: string }
  | { type: 'InvalidRange'; error: string }
  | { type: 'InvalidRow'; error: string }
  | { type: 'SpuriousDollarSign'; error: string }
  | { type: 'TooManySheets'; error: string }
  | { type: 'MismatchedQuotes'; error: string }
  | { type: 'WrongCellCount'; error: string }
  | { type: 'InvalidExclusion'; error: string }
  | { type: 'TranslateInvalid'; error: string }
  | { type: 'SheetNotFound' }
  | { type: 'InvalidTableRef'; error: string }
  | { type: 'TableNotFound'; error: string }
  | { type: 'MultipleColumnDefinitions' }
  | { type: 'MultipleRowDefinitions' }
  | { type: 'UnexpectedRowNumber' }
  | { type: 'InvalidRowRange'; error: string }
  | { type: 'OutOfBounds'; error: RefError };
...
export type BorderStyleCell = {
  top: BorderStyleTimestamp | null;
  bottom: BorderStyleTimestamp | null;
  left: BorderStyleTimestamp | null;
  right: BorderStyleTimestamp | null;
};
...
export type DateTimeRange =
  | { DateRange: [bigint | null, bigint | null] }
  | { DateEqual: Array<bigint> }
  | { DateNotEqual: Array<bigint> }
  | { TimeRange: [number | null, number | null] }
  | { TimeEqual: Array<number> }
  | { TimeNotEqual: Array<number> };
export type Format = {
  align: CellAlign | null;
  vertical_align: CellVerticalAlign | null;
  wrap: CellWrap | null;
  numeric_format: NumericFormat | null;
  numeric_decimals: number | null;
  numeric_commas: boolean | null;
  bold: boolean | null;
  italic: boolean | null;
  ...
  underline: boolean | null;
  strike_through: boolean | null;
  font_size: number | null;
};
export type FormatUpdate = {
  align: CellAlign | null | null;
  vertical_align: CellVerticalAlign | null | null;
  wrap: CellWrap | null | null;
  numeric_format: NumericFormat | null | null;
  numeric_decimals: number | null | null;
  numeric_commas: boolean | null | null;
  bold: boolean | null | null;
  italic: boolean | null | null;
  text_color: string | null | null;
  fill_color: string | null | null;
  render_size: RenderSize | null | null;
  date_time: string | null | null;
  underline: boolean | null | null;
  strike_through: boolean | null | null;
...
export type JsBorderHorizontal = {
  color: Rgba;
  line: CellBorderLine;
  x: bigint;
  y: bigint;
...
export type JsCellsA1Values = {
  cells: Array<JsCellsA1Value>;
  x: number;
  y: number;
  w: number;
  h: number;
...
export type JsCellValueSummary = {
  total_range: string;
  start_range: string | null;
  end_range: string | null;
  start_values: Array<Array<JsCellValueCode>> | null;
  end_values: Array<Array<JsCellValueCode>> | null;
};
export type JsCellValueKind =
  | 'Blank'
  | 'Text'
  | 'Number'
  | 'Logical'
...
export type JsChartContext = {
  sheet_name: string;
  chart_name: string;
  bounds: string;
  intended_bounds: string;
  language: CodeCellLanguage;
  code_string: string;
  spill: boolean;
};
export type JsClipboard = { plainText: string; html: string };
export type JsCodeCell = {
  x: bigint;
  y: bigint;
  code_string: string;
  language: CodeCellLanguage;
  ...
  spill_error: Array<Pos> | null;
  return_info: JsReturnInfo | null;
  cells_accessed: Array<JsCellsAccessed> | null;
  last_modified: bigint;
};
export type JsCodeResult = {
  transaction_id: string;
  success: boolean;
  std_out: string | null;
  std_err: string | null;
  line_number: number | null;
  output_value: JsCellValueResult | null;
  output_array: Array<Array<JsCellValueResult>> | null;
  output_display_type: string | null;
  chart_pixel_output: [number, number] | null;
  has_headers: boolean;
};
export type JsCodeErrorContext = {
  sheet_name: string;
  pos: string;
  name: string;
  language: CodeCellLanguage;
...
export type JsCodeTableContext = {
  ...
  values: JsCellValueSummary | null;
  bounds: string;
  intended_bounds: string;
  show_name: boolean;
...
export type JsDataTableContext = {
  sheet_name: string;
...
export type JsFormulaParseResult = {
  parse_error_msg: string | null;
  parse_error_span: Span | null;
  cells_accessed: Array<JsCellsAccessed>;
  spans: Array<Span>;
};
export type JsGetAICellResult = {
  selection: string;
  page: number;
  total_pages: number;
  values: Array<JsCellValueRanges>;
};
...
export type JsRenderCell = {
   ...
   */
  language: CodeCellLanguage | null;
  align: CellAlign | null;
  verticalAlign: CellVerticalAlign | null;
  wrap: CellWrap | null;
  bold: boolean | null;
  italic: boolean | null;
  textColor: string | null;
  special: JsRenderCellSpecial | null;
  number: JsNumber | null;
  underline: boolean | null;
  strikeThrough: boolean | null;
  fontSize: number | null;
  tableName: boolean | null;
  columnHeader: boolean | null;
  /**
   * Hyperlink URL for RichText cells with hyperlinks.
   */
  link: string | null;
};
export type JsRenderCellSpecial = 'Chart' | 'SpillError' | 'RunError' | 'Logical' | 'Checkbox' | 'List';
export type JsRenderCodeCell = {
  x: number;
  y: number;
  w: number;
  h: number;
  language: CodeCellLanguage;
  state: JsRenderCodeCellState;
  spill_error: Array<Pos> | null;
  name: string;
  columns: Array<JsDataTableColumnHeader>;
  first_row_header: boolean;
  sort: Array<DataTableSort> | null;
  sort_dirty: boolean;
  alternating_colors: boolean;
  is_code: boolean;
  is_html: boolean;
  is_html_image: boolean;
  show_name: boolean;
  show_columns: boolean;
  last_modified: bigint;
};
...
export type JsSummaryContext = {
  sheet_name: string;
  data_rects: Array<JsCellValueSummary>;
  errored_code_cells: Array<JsCodeCell> | null;
  data_tables: Array<JsDataTableContext> | null;
  code_tables: Array<JsCodeTableContext> | null;
  connections: Array<JsCodeTableContext> | null;
  charts: Array<JsChartContext> | null;
};
...
export type RunErrorMsg =
  ...
  | { Unterminated: string }
  | { Expected: { expected: string; got: string | null } }
  | { Unexpected: string }
  | { TooManyArguments: { func_name: string; max_arg_count: number } }
  | { MissingRequiredArgument: { func_name: string; arg_name: string } }
  | 'BadFunctionName'
  | 'BadCellReference'
  | 'BadNumber'
  | { BadOp: { op: string; ty1: string; ty2: string | null; use_duration_instead: boolean } }
  | { ExactArraySizeMismatch: { expected: ArraySize; got: ArraySize } }
  | { ExactArrayAxisMismatch: { axis: Axis; expected: number; got: number } }
  | { ArrayAxisMismatch: { axis: Axis; expected: number; got: number } }
  | 'EmptyArray'
  | 'NonRectangularArray'
  | 'NonLinearArray'
  | 'ArrayTooBig'
...
export type SearchOptions = {
  ...
  whole_cell: boolean | null;
  search_code: boolean | null;
  sheet_id: string | null;
};
export type SheetBounds = {
  sheet_id: string;
  bounds: GridBounds;
  bounds_without_formatting: GridBounds;
...
export type TextMatch =
  ...
  | { TextLength: { min: number | null; max: number | null } };
export type TrackedOperation =
  | { type: 'SetCellValues'; selection: string }
  | { type: 'SetDataTable'; selection: string; name: string | null; deleted: boolean }
  | { type: 'DeleteDataTable'; selection: string }
  | { type: 'FlattenDataTable'; selection: string }
  | { type: 'GridToDataTable'; selection: string }
  | { type: 'MoveDataTable'; from: string; to: string }
  | { type: 'SwitchDataTableKind'; selection: string; kind: string }
  | { type: 'DataTableColumnsChanged'; selection: string }
  | { type: 'DataTableRowsChanged'; selection: string }
  | { type: 'DataTableSorted'; selection: string }
  | { type: 'DataTableHeaderToggled'; selection: string; first_row_is_header: boolean }
  | { type: 'FormatsChanged'; sheet_name: string; selection: string }
  | { type: 'AddSheet'; sheet_name: string }
  | { type: 'DeleteSheet'; sheet_name: string }
  | { type: 'DuplicateSheet'; sheet_name: string; duplicated_sheet_name: string }
  | { type: 'SetSheetName'; old_sheet_name: string; new_sheet_name: string }
  | { type: 'SetSheetColor'; sheet_name: string; color: string | null }
  | { type: 'ReorderSheet'; sheet_name: string; order: string }
  | { type: 'ReplaceSheet'; sheet_name: string }
  | { type: 'ResizeColumn'; sheet_name: string; column: bigint; new_size: number }
  | { type: 'ResizeRow'; sheet_name: string; row: bigint; new_size: number }
  | { type: 'ColumnsResized'; sheet_name: string; count: number }
  | { type: 'RowsResized'; sheet_name: string; count: number }
  | { type: 'DefaultRowSize'; sheet_name: string; size: number }
  | { type: 'DefaultColumnSize'; sheet_name: string; size: number }
  | { type: 'CursorChanged'; selection: string }
  | { type: 'MoveCells'; from: string; to: string; columns: boolean; rows: boolean }
  | { type: 'ValidationSet'; selection: string }
  | { type: 'ValidationRemoved'; sheet_name: string; validation_id: string }
  | { type: 'ValidationRemovedSelection'; sheet_name: string; selection: string }
  | { type: 'ColumnInserted'; sheet_name: string; column: bigint }
  | { type: 'ColumnDeleted'; sheet_name: string; column: bigint }
  | { type: 'RowInserted'; sheet_name: string; row: bigint }
  | { type: 'RowDeleted'; sheet_name: string; row: bigint }
  | { type: 'ColumnsDeleted'; sheet_name: string; columns: Array<bigint> }
  | { type: 'RowsDeleted'; sheet_name: string; rows: Array<bigint> }
  | { type: 'ColumnsMoved'; sheet_name: string; from_range: [bigint, bigint]; to: bigint }
  | { type: 'RowsMoved'; sheet_name: string; from_range: [bigint, bigint]; to: bigint }
  | { type: 'ComputeCode'; selection: string };
...
export type ValidationDateTime = {
  ignore_blank: boolean;
  require_date: boolean;
  require_time: boolean;
  prohibit_date: boolean;
  prohibit_time: boolean;
  ranges: Array<DateTimeRange>;
};
