import { Container, Graphics, Renderer, utils } from 'pixi.js';
...
import type { CellsImages } from '@/app/gridGL/cells/cellsImages/CellsImages';
...
import '@/app/gridGL/pixiApp/pixiApp.css';
