...
export async function loadAssets() {
  ...
  const bundle = {
    ...
    'icon-bigquery': '/images/icon-snowflake.png',
    'icon-cockroachdb': '/images/icon-snowflake.png',
    'icon-mariadb': '/images/icon-snowflake.png',
    'icon-supabase': '/images/icon-snowflake.png',
    'icon-neon': '/images/icon-snowflake.png',
