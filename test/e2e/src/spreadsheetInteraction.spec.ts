...
test('Appearance Customization', async ({ page }) => {
  ...
  await page.getByRole(`button`, { name: `discover_tune system` }).click({ timeout: 30 * 1000 });
  await page.getByRole(`button`, { name: `contrast` }).click({ timeout: 30 * 1000 });
  ...
  await page.getByRole(`button`, { name: `dark_mode dark` }).click({ timeout: 30 * 1000 });
  ...
  await page.getByRole(`button`, { name: `light_mode light` }).click({ timeout: 30 * 1000 });
...
test('Auto Focus after Closing Menus', async ({ page }) => {
  ...
  await page.getByLabel(`Date and time`).click({ timeout: 30 * 1000 });
...
test('Auto-Complete', async ({ page }) => {
  ...
  await page.locator('[aria-label="Text color"]').click({ timeout: 30 * 1000 });
  await page.waitForTimeout(5 * 1000);
  await page
    .getByRole('menuitem')
    .getByTitle('#E74C3C')
...
"Completed 10 second sleep"
  ...
  await page.getByRole(`button`, { name: `stop` }).click({ timeout: 30 * 1000 });
...
test('Cell Actions', async ({ page }) => {
  ...
  // Click `Zoom in
  await page.locator(`:text("Zoom in")`).click({ timeout: 30 * 1000 });
  ...
  await page.locator(`[role="option"]:has-text("Paste formatting only")`).click({ timeout: 30 * 1000 });
  await page.waitForTimeout(5 * 1000);
...
test('Custom DateTime Options', async ({ page }) => {
  ...
  await page.locator(`[aria-label="Date and time"]`).click({ timeout: 30 * 1000 });
...
test('Download Sheet', async ({ page }) => {
  ...
  for (const tab of tabs) {
    ...
    await page.locator(`div[data-title="${tab}"]`).click({ timeout: 30 * 1000 });
...
test('File - Clear Recent History', async ({ page }) => {
  ...
  await page.locator(`h2:text("${exampleName}")`).click({ timeout: 30 * 1000 });
  ...
  // Click "Open Recent"
  await page.getByRole(`menuitem`, { name: `file_open Open recent` }).click({ timeout: 30 * 1000 });
...
test('File - Open Recent', async ({ page }) => {
  ...
  await page.getByRole(`menuitem`, { name: `${fileName2}` }).click({ timeout: 30 * 1000 });
  await page.waitForTimeout(10 * 1000);
  await page.waitForLoadState('domcontentloaded');
  await quadraticLoading.waitFor({ state: 'hidden', timeout: 2 * 60 * 1000 });
  ...
  await page.getByRole(`menuitem`, { name: `File` }).click({ timeout: 30 * 1000 }); // Click File
  await page.getByRole(`menuitem`, { name: `file_open Open recent` }).click({ timeout: 30 * 1000 }); // Click Open recent
...
test('Find in current sheet', async ({ page }) => {
  ...
  await page.getByRole(`menuitem`, { name: `Edit` }).click({ timeout: 30 * 1000 });

  // Click `Find in current sheet` option
  await page.getByRole(`menuitem`, { name: `pageview Find in current` }).click({ timeout: 30 * 1000 });
...
test('Insert and Delete Columns', async ({ page }) => {
  ...
  // Rename file
  await page.getByRole(`button`, { name: `Insert_row_col` }).click({ timeout: 30 * 1000 });
  ...
  await page.getByText(`Insert column left`).click({ timeout: 30 * 1000 });
  ...
  await page.getByText(`Insert column right`).click({ timeout: 30 * 1000 });
  ...
  // Click Delete column
  await page.getByText(`Delete 1 column`).click({ timeout: 30 * 1000 });
...
test('Insert and Delete Multiple Columns', async ({ page }) => {
  ...
  // Rename file
  await page.getByRole(`button`, { name: fileName }).click({ timeout: 30 * 1000 });
  await page.keyboard.type(fileName, { delay: 50 });
  ...
  await page.getByText(`Insert 3 columns left`).click({ timeout: 30 * 1000 });
  ...
  await page.getByText(`Insert 3 columns right`).click({ timeout: 30 * 1000 });
...
test('Insert and Delete Rows', async ({ page }) => {
  ...
  await page.getByText(`Insert row above`).click({ timeout: 30 * 1000 });
  ...
  await page.getByText(`Insert row below`).click({ timeout: 30 * 1000 });
  ...
  // Click Delete row
  await page.getByText(`Delete 1 row`).click({ timeout: 30 * 1000 });
...
test('Insert and Delete Multiple Rows', async ({ page }) => {
  ...
  await page.getByText(`Insert 3 rows above`).click({ timeout: 30 * 1000 });
  ...
  await page.getByText(`Insert 3 rows below`).click({ timeout: 30 * 1000 });
  ...
  // Click Delete column
  await page.getByText(`Delete 8 rows`).click({ timeout: 30 * 1000 });
...
test('Left and Right Sheet Navigation', async ({ page }) => {
  ...
  await page.locator(`[data-title="Sheet 1"]`).click({ timeout: 30 * 1000 });
  ...
  while (await rightChevron.isEnabled()) {
    await rightChevron.click({ timeout: 30 * 1000 });
  ...
  while (await leftChevron.isEnabled()) {
    await leftChevron.click({ timeout: 30 * 1000 });
    await page.waitForTimeout(100);
  }
...
test('Log Out From Sheet', async ({ page }) => {
  ...
  await page.locator('button:has(img[alt*="You"])').click({ timeout: 30 * 1000 });

  // Select Log Out
  await page.getByRole(`menuitem`, { name: `Log out` }).click({ timeout: 30 * 1000 });
  await page.waitForTimeout(10 * 1000);
  await page.waitForLoadState('domcontentloaded');
...
test('Multi-Delete Columns', async ({ page }) => {
  ...
  // Click Delete
  await page.getByText(`Delete 3 columns`).click({ timeout: 30 * 1000 });
  //--------------------------------
  // Assert:
  //--------------------------------
...
test('Multi-Delete Rows', async ({ page }) => {
  ...
  // Click Delete 3 rows
  await page.getByText(`Delete 3 rows`).click({ timeout: 30 * 1000 });
  //--------------------------------
  // Assert:
  //--------------------------------
...
test('Python More Snippets', async ({ page }) => {
  ...
  await page.getByText('Python', { exact: true }).click({ timeout: 30 * 1000 });
  await page.waitForTimeout(2000);

  // Click on the More Snippets button
  await page.getByRole(`button`, { name: `More snippets` }).click({ timeout: 30 * 1000 });
  ...
  await page.getByText('Read data from the sheet').click({ timeout: 30 * 1000 });
...
test('Python Snippets', async ({ page }) => {
  ...
  await page.getByRole(`button`, { name: `integration_instructions`, exact: true }).click({ timeout: 30 * 1000 });
  ...
  await page.getByText('Return data to the sheet').click({ timeout: 30 * 1000 });
...
test('Range Cell Reference - Javascript', async ({ page }) => {
  ...
  await page.locator(`[data-title="Sheet 2"]`).click({ timeout: 30 * 1000 });
...
test('Range Cell Reference - Python', async ({ page }) => {
  ...
  await page.getByRole(`button`, { name: `ink_selection` }).click({ timeout: 30 * 1000 });
  await page.waitForTimeout(5 * 1000);
...
test('Scroll between sheets', async ({ page }) => {
  ...
  await lastSheetEl.click({ timeout: 30 * 1000 });
...
test('Search - Case sensitive search', async ({ page }) => {
  ...
  await page.getByRole(`menuitemcheckbox`, { name: `Case sensitive search` }).click({ timeout: 30 * 1000 });

  // Click body (playground flakiness)
  await page.locator(`body`).click({ timeout: 30 * 1000 });
...
test('Search - Match entire cell contents', async ({ page }) => {
  ...
  await page.getByRole(`menuitemcheckbox`, { name: `Match entire cell contents` }).click({ timeout: 30 * 1000 });
...
test('Search - Search within code', async ({ page }) => {
  ...
  await page.getByRole(`menuitemcheckbox`, { name: `Search within code` }).click({ timeout: 30 * 1000 });
...
test('Spill Auto-Fix', async ({ page }) => {
  ...
  await page.getByText(`Fix arrow_drop_down`).click({ timeout: 30 * 1000 });
...
test('Theme Customization', async ({ page }) => {
  ...
  for (const theme of expectedThemes) {
    ...
    // Click accent color
    await page.getByRole(`button`, { name: theme.name }).click({ timeout: 30 * 1000 });
...
test('Zoom In and Out', async ({ page }) => {
  ...
  // Click `Zoom in
  await page.getByRole('menuitem', { name: 'Zoom in Ctrl+' }).click({ timeout: 30 * 1000 });
  ...
  // Click `Zoom out
  await page.getByRole('menuitem', { name: 'Zoom out Ctrl-' }).click({ timeout: 30 * 1000 });
  await page.waitForTimeout(5 * 1000);
...
test('Charts Copy Paste', async ({ page }) => {
  ...
  await page.getByRole(`button`, { name: `Create chart` }).click({ timeout: 30 * 1000 });
